...
# For different condtitons occur in the programming 
# we might need to change our implementation 

# Python is a space sensitive language 
# Indentation is 4 spaces, it shows which statment the implementation belongs 
...
# if user enters aa string with all lower cases print 
...
if(str.islower()):
    print("you entered correct class")     #1
