...
print(var1.isalpha())
#   False 
# Spaces are not considered as letters therefor this will return false 

print(var1.replace(" ","").isalpha())
# True 

var2 = "Weatheroutsideisnice."
print(var2.isalpha()) #False 
...
# isalpha = alphabetic only (no numbers, blank spaces or numbers. only letters_
# isnumeric = numeric only (only numbers)
# isalnum = alpha or numeric (only letters and numbers)
